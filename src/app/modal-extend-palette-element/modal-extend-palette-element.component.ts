...
@Output() newElementCreated = new EventEmitter();
  ...
  ngOnInit() {
    ...
    this.activityImageList = [
      ...
      {"imageURL":VariablesSettings.activitiesImagePath+"PaymentTask.png", "imageName":"PaymentTask.png", "label":"Payment Task", "thumbnailURL":VariablesSettings.activitiesImagePath+"Thumbnail_PaymentTask", "thumbnailName" : "Thumbnail_PaymentTask"},
