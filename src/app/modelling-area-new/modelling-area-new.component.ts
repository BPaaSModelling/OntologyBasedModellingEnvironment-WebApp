...
@Component({
  selector: 'app-modelling-area-new',
  templateUrl: './modelling-area-new.component.html',
  // template: '<div id="cy"></div>',
  styleUrls: ['./modelling-area-new.component.css']
})
export class ModellingAreaNewComponent implements OnInit {

  public constructor(public mService: ModellerService, public matDialog: MatDialog) {
    console.log('Constructor of graph');
    (go as any).Diagram.licenseKey = '';
